...
export class LoggedInForm extends Component {
	 ...
	 *
	 * @param  {?string} props.authFrom     Where is the request from
	 * @param  {?number} props.authClientId Remote site ID
	...
	isSso( { authFrom, authClientId } = this.props ) {
		...
		const jetpack_sso_approved = cookies.jetpack_sso_approved
			...
			: null;
		return 'sso' === authFrom && !! authClientId && authClientId === jetpack_sso_approved;
	}
